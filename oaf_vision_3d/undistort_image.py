...
def undistort_image_with_new_camera_matrix(
    ...
    distorted_pixels = (
        distorted_normalized_pixels * np.array([lens_model.camera_matrix.fx, lens_model.camera_matrix.fy])[None, None, :]
    ) + np.array([lens_model.camera_matrix.cx, lens_model.camera_matrix.cy])[None, None, :]
